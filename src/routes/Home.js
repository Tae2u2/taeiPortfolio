        ...
        <div className="home-text">
          ...
          <p>
            <span>
              ...
              남미 지역에서 필수 가축이듯이 저 역시 자신의 자리에서 꼭 필요한
              존재가 되는 강태이입니다. 긍정적인 성격으로 어디서나 적응도
              잘하고, 주변 사람들과 잘 지내는 건 첫눈에 들어오는 저의
              특징입니다. 그러나 함께 일했던 분들은 마지막엔 더 함께 일하고 싶은
              사람으로 저를 기억합니다. 주인의식과 위기 대처능력이 있는 직원,
              다재다능하고 손이 빨랐던 아르바이트생, 추진력과 새로운 아이디어가
              가득했던 동아리 부장으로서 제가 맡았던 자리를 넘치게 채웠습니다.
              안데스산맥에서 더 빛을 발하는 알파카처럼 결정적인 순간에 더
              반짝이는 인재, 강태이입니다.
            </span>
          </p>
        </div>
